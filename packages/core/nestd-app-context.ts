...
import { LoggerService, Logger } from "../common/services/logger.service";
import { isNil, isUndefined } from "../common/utils/shared.utils";
import iterate from "iterare";
import { INestdAppContext } from "../common/interfaces/nestd-app-context.interface";
...
import { OnAppBootstrap } from "../common/interfaces/on-app-bootstrap.interface";
  ...
  protected async callModuleBootstrapHook(module: Module): Promise<any> {
    ...
    await Promise.all(
      iterate(providers)
        ...
        .map(async instance =>
          (instance as OnAppBootstrap).onAppBootstrap(),
        ),
    )
